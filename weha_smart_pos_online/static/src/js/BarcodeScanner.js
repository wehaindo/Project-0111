odoo.define('weha_smart_pos_online.barcode_scan', function(require) {
        ...
        scan_product: function(parsed_code) {
            ...
            rpc.query({
                ...
                if(product_object.type === 'product'){
                    ...
                    const stock_quant = product_object.stock_quants.filter(val => val.location_id === self.config.stock_location_id[0]);
                    ...
                    if(product_object.qty_available > 0){                
                        console.log('qty_available');
                        self.db.add_products([product_object]);                                       
    ...
    models.Product = models.Product.extend({      
        get_price: function(pricelist, quantity) {           
            console.log("weha_smart_pos_onlie.get_price");    
            var self = this;
            ...
            var pricelist_items = _.filter(items, function (item) {
                console.log(item);
                console.log(self.product_tmpl_id);
